            ...
            <div className="bg-linear-to-r from-amber-50 via-white to-amber-50 min-h-screen py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center py-12">
                        ...
                        <div className="w-24 h-1 bg-linear-to-r from-amber-600 to-orange-500 mx-auto rounded-full mb-6"></div>
                        <p className="text-gray-600 mb-6">
                            Sorry, the product you're looking for doesn't exist or has been removed.
                        </p>
                        <Link
                            href="/all-products"
                            className="inline-flex items-center gap-2 bg-linear-to-r from-amber-600 to-orange-500 text-white px-6 py-3 rounded-lg font-semibold hover:from-amber-700 hover:to-orange-600 transition-all hover:scale-105 shadow-md"
                        >
                            ← Back to Products
                        </Link>
                    </div>
